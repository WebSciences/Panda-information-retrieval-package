...
public final class SegmentInfo {
   ...
   */
  public void reset(SegmentInfo src) {
    clearFiles();
    name = src.name;
 ...
 public String getDelFileName() {
   ...
   */
  public void advanceNormGen(int fieldIndex) {
 ...
 public void setDocStoreIsCompoundFile(boolean v) {
 ...
 public void setDocStoreOffset(int offset) {
