...
public class TrecRetrieval {
	...
	public void process (String index, String topics, String qrels, String var, int modelNumber, int MMRorPortfolio, double b1, int maxdocs) throws Exception{
      ...
      //       System.out.println("Number of queries: "+qqs.length);
	    ...
	    QualityStats stats[] = qrun.execute(judge, submitLog, logger, scorelogger, 0, 0, MMRorPortfolio, b1, maxdocs);
       ...
       */
	    ...
	    System.out.printf("The value of parameter %f\n", a1);
	    System.out.println(java.lang.Runtime.getRuntime().maxMemory()); 
	    QualityStats stats[] = qrun.execute(judge, submitLog, null, scorelogger, a1, 0, 0, -1, 10);
	...
	*/
        ...
        public void batchAdjust (String index, String topics, String qrels, String var, int modelNumber, int MMRorPortfolio, double batchA, double batchB, double batchIncrement, int maxdocs) throws Exception{
           ...
           */
    	    ...
    	    for(double b1=batchA; b1<=batchB; b1+=batchIncrement){
    	    System.out.printf("The value of parameter %f\n", b1);
    	    System.out.println(java.lang.Runtime.getRuntime().maxMemory()); 
    	    QualityStats stats[] = qrun.execute(judge, submitLog, null, scorelogger, 0, 0, MMRorPortfolio, b1, maxdocs);

    	    // print an avarage sum of the results
    	    QualityStats avg = QualityStats.average(stats);
    	    avg.batch_log(Double.toString(b1) , 2, logger, "  ");
