...
public class NormalDist extends ContinuousDistribution {
   ...
   static final protected double RAC2PI = 2.50662827463100050; // Sqrt(2*Pi)
  ...
  /*
   ...
   public static double barF (double mu, double sigma, double x) {
    ...
    private static final double[] InvNormal2P1 = {
    ...
    private static final double[] InvNormal2Q1 = {
    ...
    private static final double[] InvNormal2P2 = {
    ...
    private static final double[] InvNormal2Q2 = {
    ...
    private static final double[] InvNormal2P3 = {
    ...
    private static final double[] InvNormal2Q3 = {
...
/*        if (u < Num.DBL_MIN)
    ...
    *   with mean <SPAN CLASS="MATH"><I>&#956;</I></SPAN> and variance <SPAN CLASS="MATH"><I>&#963;</I><SUP>2</SUP></SPAN>.
    *   Uses rational Chebyshev approximations giving at least 16 decimal
    *   digits of precision.
    *
    */
   ...
   public static NormalDist getInstanceFromMLE (double[] x, int n) {
      double parameters[] = getMaximumLikelihoodEstimate (x, n);
