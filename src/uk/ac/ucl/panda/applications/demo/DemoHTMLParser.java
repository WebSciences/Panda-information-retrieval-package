package uk.ac.ucl.panda.applications.demo;
 ...
 */
public class DemoHTMLParser implements uk.ac.ucl.panda.utility.parser.HTMLParser {
  ...
  /*
   *  (non-Javadoc)
   * @see uk.ac.ucl.panda.utility.parser.HTMLParser#parse(java.lang.String, java.util.Date, java.io.Reader, java.text.DateFormat)
   */
  public DocData parse(String name, Date date, Reader reader, DateFormat dateFormat) throws IOException, InterruptedException {
    uk.ac.ucl.panda.applications.demo.HTMLParser p = new uk.ac.ucl.panda.applications.demo.HTMLParser(reader);
  ...
  /*
   *  (non-Javadoc)
   * @see uk.ac.ucl.panda.utility.parser.HTMLParser#parse(java.lang.String, java.util.Date, java.lang.StringBuffer, java.text.DateFormat)
   */
