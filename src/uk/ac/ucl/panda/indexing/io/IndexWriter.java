...
import uk.ac.ucl.panda.indexing.io.BitVector;
...
import uk.ac.ucl.panda.utility.structure.FSDirectory;
...
public class IndexWriter {
   ...
   * UCL Panda change to 192
   */
  public final static int DEFAULT_TERM_INDEX_INTERVAL = 192;
   ...
   */
  public void setNormalise(Normalise normalise) {
    ensureOpen();
  ...
  */
  ...
  public final synchronized void mergeInit(MergePolicy.OneMerge merge) throws IOException {
  ...
  public synchronized void addMergeException(MergePolicy.OneMerge merge) {
